...
import 'package:flutter_application_3/View/signup/registration_success_page.dart';
                  ...
                  child: Column(
                    children: [
                      const CircleAvatar(
                        ...
                        child: Icon(Icons.sports, color: kTextPrimary, size: 40),
                      ),
                        ...
                        child: Column(
                          children: [
                            _buildDropdownField(
                              ...
                              items: ['Batting Coach', 'Bowling Coach', 'Fielding Coach', 'Head Coach', 'Strategist'],
                            ...
                            const SizedBox(height: 16),
                            _buildTextField(controller: _certificationsController, label: 'Certifications', hint: 'e.g., UEFA License'),
                            const SizedBox(height: 16),
                            _buildTextField(controller: _locationController, label: 'Location', hint: 'City, State'),
                            const SizedBox(height: 16),
                            _buildTextField(controller: _philosophyController, label: 'Coaching Philosophy', hint: 'Describe your approach', maxLines: 3),
                          ],
                        ),
                      ),
                      const SizedBox(height: 32),
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Radio<bool>(value: true, groupValue: _useEmail, onChanged: (v) => setState(() => _useEmail = v!), activeColor: kAccentCyan),
            Text('Email', style: TextStyle(color: _useEmail ? kTextPrimary : kTextSecondary)),
            Radio<bool>(value: false, groupValue: _useEmail, onChanged: (v) => setState(() => _useEmail = v!), activeColor: kAccentCyan),
        ...
        Row(
          ...
          children: [
            Expanded(child: _useEmail ? _buildTextField(controller: _emailController, label: 'Email') : _buildTextField(controller: _phoneController, label: 'Phone', keyboardType: TextInputType.phone)),
            ...
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: _otpVerified ? Colors.green : kAccentCyan, padding: const EdgeInsets.symmetric(vertical: 14)),
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: kAccentCyan, width: 2)),
      ),
